...
@app.get("/integrations/jira/connection", response_model=JiraConnectionStatusResponse)
...
@app.post("/integrations/jira/connection", response_model=JiraConnectionStatusResponse)
...
@app.delete("/integrations/jira/connection", response_model=JiraConnectionDeleteResponse)
...
@app.get("/integrations/jira/projects", response_model=JiraProjectsResponse)
...
@app.get("/integrations/jira/projects/{project_key}/issue-types", response_model=JiraProjectIssueTypesResponse)
...
@app.get("/integrations/jira/issues/search", response_model=JiraIssueSearchResponse)
...
@app.post("/integrations/jira/import", response_model=RequirementsWorkflowResponse)
async def jira_import_requirements_endpoint(
    ...
    try:
        workflow = await run_in_threadpool(import_requirements_from_jira, current_user=current_user, payload=payload)
        response = RequirementsWorkflowResponse(
...
@app.post("/integrations/jira/sync/preview", response_model=JiraSyncPreviewResponse)
...
@app.post("/integrations/jira/sync", response_model=JiraSyncApplyResponse)
