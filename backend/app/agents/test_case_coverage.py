...
def _normalize_coverage_plan(raw_plan: List[Dict[str, Any]], requirements: List[Requirement]) -> List[Dict[str, Any]]:
    ...
    for requirement in requirements:
        ...
        # Missing categories are review findings, not evidence of missing model
        # output. Keep concrete plans intact; generic fallback belongs only to
        # missing or empty groups above, never as padding on successful output.
        normalized_plan.append(existing)
