...
- `GEMINI_API_KEY`
- `MODEL_NAME`
- `PARALLEL_TEST_CASE_GENERATION_ENABLED`
- `PARALLEL_TEST_CASE_MIN_SCENARIOS`
- `PARALLEL_TEST_CASE_MAX_WORKERS`
- `PARALLEL_TEST_CASE_TARGET_SCENARIOS_PER_SHARD`
- `PARALLEL_TEST_CASE_MAX_SHARDS`
- `PARALLEL_AUTOMATION_GENERATION_ENABLED`
- `PARALLEL_AUTOMATION_MIN_CASES`
- `PARALLEL_AUTOMATION_MAX_WORKERS`
- `JWT_SECRET_KEY`
- `JWT_ALGORITHM`
