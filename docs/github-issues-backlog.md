...
- Epic [#35](https://github.com/lumensparkxy/agentic_test_case_generator/issues/35) - Reduce high-churn architecture hotspots
  ...
  - Done: [#42](https://github.com/lumensparkxy/agentic_test_case_generator/issues/42) - Split backend Pydantic contracts by domain
...
- Done Epic [#159](https://github.com/lumensparkxy/agentic_test_case_generator/issues/159) - Make test-case generation shard-first and provenance-aware
  ...
  - Done: [#166](https://github.com/lumensparkxy/agentic_test_case_generator/issues/166) - Show generation source breakdown in workflow diagnostics
...
- Frontend workflow usability
  ...
  - Done: [#225](https://github.com/lumensparkxy/agentic_test_case_generator/issues/225) - Remove the redundant Project Information Rail from the workspace
  - Done: [#227](https://github.com/lumensparkxy/agentic_test_case_generator/issues/227) - Compact workspace controls into a single-row app bar
  - In progress: [#229](https://github.com/lumensparkxy/agentic_test_case_generator/issues/229) - Show one icon per workflow stage in the collapsed rail
...
- Done: [#214](https://github.com/lumensparkxy/agentic_test_case_generator/issues/214) - Deploy Home workspace API and required Firestore indexes
