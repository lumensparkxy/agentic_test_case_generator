...
- Epic [#159](https://github.com/lumensparkxy/agentic_test_case_generator/issues/159) - Make test-case generation shard-first and provenance-aware
  ...
  - In progress: [#162](https://github.com/lumensparkxy/agentic_test_case_generator/issues/162) - Use dynamic shard-first generation for large coverage plans
  - Ready: [#163](https://github.com/lumensparkxy/agentic_test_case_generator/issues/163) - Enforce exact planned scenario references in coverage review
